...
// Source: https://store.fastly.steamstatic.com/public/javascript/applications/store/11031.js
var steamLocTokenStrings = map[string]string{
	"language":                             "english",
	...
	"Button_Paste":                         "Paste",
	"Button_Pasted":                        "Pasted!",
	"Button_PasteClipboard":                "Paste from Clipboard",
	...
	"Button_StartDownload":                 "Start Download",
	"Button_Edit":                          "Edit",
	...
	"Button_No":                            "No",
	"Button_Yes":                           "Yes",
	"Button_InstallSteam":                  "Install Steam",
	...
	"AppHub_Nav_All":                                                      "All",
	"AppHub_Nav_Discussions":                                              "Discussions",
	"AppHub_Nav_WorkshopItems":                                            "Workshop",
	"AppHub_Nav_Videos":                                                   "Videos",
	"AppHub_Nav_Screenshots":                                              "Screenshots",
	"AppHub_Nav_News":                                                     "News",
	"AppHub_Nav_Announcements":                                            "Official Announcements",
	"AppHub_Nav_SyndicatedNews":                                           "Syndicated News",
	"AppHub_Nav_AllNews":                                                  "News",
	"AppHub_Nav_Art":                                                      "Artwork",
	"AppHub_Nav_Recommendations":                                          "Recommendations",
	"AppHub_Nav_OfficialGroup":                                            "Official Group",
	"AppHub_Nav_FriendActivity":                                           "Friend Activity",
	"AppHub_Nav_Guides":                                                   "Guides",
	"AppHub_Nav_Reviews":                                                  "Reviews",
	"AppHub_Nav_Admin":                                                    "Hub Admin",
	"AppHub_Nav_AdminLinks":                                               "Admin Links",
	"AppHub_Nav_Broadcasts":                                               "Broadcasts",
	"AppHub_Store":                                                        "Store Page",
	"AppHubs_ContentCheck_ViewPage":                                       "View Community Hub",
	"AppHubs_ContentCheck_ViewItem":                                       "View Item",
	"AppHubs_ContentCheck_Cancel":                                         "Cancel",
	"AppHubs_ContentCheck_Header_App":                                     "THIS GAME CONTAINS CONTENT YOU HAVE ASKED NOT TO SEE:",
	"AppHubs_ContentCheck_Header_Item":                                    "THIS ITEM CONTAINS CONTENT YOU HAVE ASKED NOT TO SEE:",
	"AppHubs_ContentCheck_Dev_Header":                                     "The developers describe the content like this:",
	"AppHubs_ContentCheck_Affirmation":                                    "By clicking the “View” button below you affirm that you are at least eighteen years old.",
	"AppHubs_ContentCheck_LoggedOut":                                      "You must be logged in to view this Community Hub.",
	"AppHubs_ContentCheck_LoggedOut_Item":                                 "You must be logged in to view this item.",
	"AppHubs_ContentCheck_Invalid":                                        "You have requested to view a Community Hub that does not exist.",
	"AppHubs_ContentCheck_NotAvailable":                                   "This Community Hub is not available in your region (%1$s).",
	"AppHubs_ContentCheck_ContentDescriptors":                             "This Community Hub is marked as 'Adult Only'. It cannot be viewed without first logging into Steam.",
	"AppHubs_ContentCheck_CommunityContentDescriptors":                    "This Community Hub has content that is not available in your region.",
	"AppHubs_ContentCheck_NotAvailable_Item":                              "This content is not available in your region.",
	"AppHubs_ContentCheck_UpdatePrefs":                                    "Want to update what type of content you see on Steam?",
	"AppHubs_ContentCheck_UpdatePrefs_Link":                               "Update Content Preferences",
	"AppHubs_ContentCheck_SetCookie":                                      "This Community Hub is marked as 'Adult Only'. You are seeing this hub because you have agreed to continue to it.",
	"AppHubs_ContentCheck_SetPreferences":                                 "This Community Hub is marked as 'Adult Only'. You are seeing this hub because you have set your preferences to allow this content.",
	"AppHubs_ContentCheck_SetCookie_Item":                                 "This content is normally hidden based on your preferences. You are seeing this item because you have agreed to view it.",
	"AppHubs_ContentCheck_Moderator":                                      "This Community Hub is marked as 'Adult Only'. You are seeing this hub because you have moderator permissions.",
	"AppHubs_ForbiddenByParentalControls_AppHub":                          "This Community Hub contains the following kinds of content that has blocked by your Steam Family:",
	"AppHubs_ForbiddenByParentalControls_Item":                            "This item contains the following kinds of content blocked by your Steam Family:",
	"Settings":                                                            "Settings",
	...
	"EventCalendar_NewsChannel_AllSales":                                  "Sales Events",
	...
	"EventDisplay_Admin_Close_ttip":                                       "Temporarily sends this bar to the bottom of the page.",
	"EventDisplay_Admin_Reopen_ttip":                                      "Attaches this bar back to the bottom of the window.",
	...
	"EventDisplay_LinksDropDown_ExtraShort":                               "Links",
	...
	"EventDisplay_OnWishlist":                                             "On your wishlist",
	"EventDisplay_Follow":                                                 "Game that you follow",
	...
	"EventDisplay_CallToAction_ComingSoon_Date":                           "Available: %1$s",
	...
	"EventDisplay_CallToAction_Free":                                      "Free",
	...
	"EventDisplay_CategoryEditor":                                         "(VO) Content Hub Category Editor",
	...
	"EventDisplay_SocialTitle":                                            "More Ways To Connect:",
	"EventDisplay_Sketchfab":                                              "Sketchfab Model",
	"EventDisplay_SketchFab_Error_Network":                                "Could not contact Sketchfab",
	"EventDisplay_Sale_SocialTitle":                                       "More Ways To Connect with Event Host:",
	"EventDisplay_Sale_SocialTitle_Dev":                                   "More Ways To Connect with this creator:",
	...
	"EventEditor_Edit_Page":                                               "Edit Page",
	...
	"EventEmail_Button_BuyWithoutPSU":                                     "Buy without PSU",
	"EventEmail_Button_BuyWithoutPSUOutOfStock":                           "Buy without PSU (Out of stock)",
	"EventDashBoard_SummaryStats_Admin_Title":                             "(Visible only to admins)",
	"EventDashBoard_SummaryStats_Title":                                   "Visibility Stats",
	"EventDashBoard_SummaryStats_Details":                                 "Detailed Breakdown",
	"EventDashBoard_SummaryStats_Export":                                  "Download .csv",
	"EventDashBoard_SummaryStats_AboutStats":                              "See Documentation",
	...
	"EventDashBoard_Summary_AppDetailSpotlight_Shown":                     "Impressions of 'Featured Event':",
	"EventDashBoard_Summary_AppDetailSpotlight_Read":                      "Clicks on a 'Featured Event' to view details:",
	...
	"EventEditor_SaleValveApproval_Request_Desc3":                         "The sale page will be locked once it’s been reviewed. If you need to make changes after the review or once the event starts, please write in the comment what those changes entail and why they couldn’t be completed before the review.",
	...
	"EventEditor_SaleValveApproval_Request_DuplicateError":                "Unable to create a new ticket; a ticket of this type already exists. Please complete review of your other sale page before submitting this one or update the existing ticket to also include this page's review.",
	...
	"StoreCapsule_App_Excluded":                                           "Game excluded from display based on your <1>store preferences</1>.",
	"StoreCapsule_Package_Excluded":                                       "Package excluded from display based on your <1>store preferences</1>.",
	"StoreCapsule_Bundle_Excluded":                                        "Bundle excluded from display based on your <1>store preferences</1>.",
	"AddToWishlist_short":                                                 "+ Wishlist",
	"Wishlisted":                                                          "On your Wishlist",
	"Wishlisted_short":                                                    "Wishlist",
	"AddToYourWishlist":                                                   "Add to your wishlist",
	"AddToWishlist_ttip":                                                  "Add to your wishlist. Get notified by email when your wishlisted items get released or are on sale.",
	"RemoveFromWishlist_ttip":                                             "This item is on your wishlist. Get notified by email when your wishlisted items get released or are on sale.",
	...
	"language_selection_portuguese":                                       "Português - Portugal (Portuguese - Portugal)",
	...
	"language_selection_malay":                                            "Bahasa Melayu (Malay)",
	"language_ext_afrikaans":                                              "Afrikaans",
	"language_ext_albanian":                                               "Albanian",
	"language_ext_amharic":                                                "Amharic",
	"language_ext_armenian":                                               "Armenian",
	"language_ext_assamese":                                               "Assamese",
	"language_ext_azerbaijani":                                            "Azerbaijani",
	"language_ext_bangla":                                                 "Bangla",
	"language_ext_basque":                                                 "Basque",
	"language_ext_belarusian":                                             "Belarusian",
	"language_ext_bosnian":                                                "Bosnian",
	"language_ext_catalan":                                                "Catalan",
	"language_ext_cherokee":                                               "Cherokee",
	"language_ext_croatian":                                               "Croatian",
	"language_ext_dari":                                                   "Dari",
	"language_ext_estonian":                                               "Estonian",
	"language_ext_filipino":                                               "Filipino",
	"language_ext_galician":                                               "Galician",
	"language_ext_georgian":                                               "Georgian",
	"language_ext_gujarati":                                               "Gujarati",
	"language_ext_gurmukhi":                                               "Punjabi (Gurmukhi)",
	"language_ext_hausa":                                                  "Hausa",
	"language_ext_hebrew":                                                 "Hebrew",
	"language_ext_hindi":                                                  "Hindi",
	"language_ext_icelandic":                                              "Icelandic",
	"language_ext_igbo":                                                   "Igbo",
	"language_ext_indonesian":                                             "Indonesian",
	"language_ext_irish":                                                  "Irish",
	"language_ext_kannada":                                                "Kannada",
	"language_ext_kazakh":                                                 "Kazakh",
	"language_ext_khmer":                                                  "Khmer",
	"language_ext_kiche":                                                  "K'iche'",
	"language_ext_kinyarwanda":                                            "Kinyarwanda",
	"language_ext_konkani":                                                "Konkani",
	"language_ext_kyrgyz":                                                 "Kyrgyz",
	"language_ext_latvian":                                                "Latvian",
	"language_ext_lithuanian":                                             "Lithuanian",
	"language_ext_luxembourgish":                                          "Luxembourgish",
	"language_ext_macedonian":                                             "Macedonian",
	"language_ext_malay":                                                  "Malay",
	"language_ext_malayalam":                                              "Malayalam",
	"language_ext_maltese":                                                "Maltese",
	"language_ext_maori":                                                  "Maori",
	"language_ext_marathi":                                                "Marathi",
	"language_ext_mongolian":                                              "Mongolian",
	"language_ext_nepali":                                                 "Nepali",
	"language_ext_odia":                                                   "Odia",
	"language_ext_persian":                                                "Persian",
	"language_ext_quechua":                                                "Quechua",
	"language_ext_scots":                                                  "Scots",
	"language_ext_serbian":                                                "Serbian",
	"language_ext_shahmukhi":                                              "Punjabi (Shahmukhi)",
	"language_ext_sindhi":                                                 "Sindhi",
	"language_ext_sinhala":                                                "Sinhala",
	"language_ext_slovak":                                                 "Slovak",
	"language_ext_slovenian":                                              "Slovenian",
	"language_ext_sorani":                                                 "Sorani",
	"language_ext_sotho":                                                  "Sotho",
	"language_ext_swahili":                                                "Swahili",
	"language_ext_tajik":                                                  "Tajik",
	"language_ext_tamil":                                                  "Tamil",
	"language_ext_tatar":                                                  "Tatar",
	"language_ext_telugu":                                                 "Telugu",
	"language_ext_tigrinya":                                               "Tigrinya",
	"language_ext_tswana":                                                 "Tswana",
	"language_ext_turkmen":                                                "Turkmen",
	"language_ext_urdu":                                                   "Urdu",
	"language_ext_uyghur":                                                 "Uyghur",
	"language_ext_uzbek":                                                  "Uzbek",
	"language_ext_valencian":                                              "Valencian",
	"language_ext_welsh":                                                  "Welsh",
	"language_ext_wolof":                                                  "Wolof",
	"language_ext_xhosa":                                                  "Xhosa",
	"language_ext_yoruba":                                                 "Yoruba",
	"language_ext_zulu":                                                   "Zulu",
	...
	"EventEditor_ReplaceImage_Title":                                      "Replace Image",
	...
	"EventEditor_EditVideo_Title":                                         "Embed Video",
	"EventEditor_InsertVideo_InputMP4":                                    "MP4 URL",
	"EventEditor_InsertVideo_InputWebM":                                   "WebM URL",
	"EventEditor_InsertVideo_InputPoster":                                 "Poster URL (optional)",
	"EventEditor_InsertVideo_InputAutoplay":                               "Autoplay",
	"EventEditor_InsertVideo_InputShowControls":                           "Show Controls",
	...
	"EventEditor_UserPoll":                                                "User Poll",
	...
	"Image_ErrorTitle":                                                    "Failed to Load Image '%1$s'.",
	"Image_Error_msg1":                                                    "Steam Events and Announcement no longer support displaying images hosted off of Steam.",
	"Image_Error_suggestion":                                              "Please upload the image to Steam to host the content for free.",
	"Image_Externally_Hosted_Hidden":                                      "This image is from another website, and your current cookie settings are blocking it. To see the image, you’ll need to accept all cookies. You can review and change your <1>cookie preferences here</1>.",
	"Platform_Hint_Mobile":                                                "on Mobile Device",
	"Platform_Hint_BigPicture":                                            "in Big Picture",
	"Platform_Hint_VR":                                                    "in Virtual Reality",
	"Platform_Hint_SteamDeck":                                             "on Steam Deck",
	"Platform_Hint_LegionGoS":                                             "on Legion Go S",
	...
	"WriteReview_Dialog_HardwareSpecs":                                    "Attach PC Specs to this review",
	"WriteReview_Dialog_HardwareSpecs_ttip":                               "If you've saved some of your hardware information to Steam, you can attach it to your review and it will be shown to other users.",
	...
	"PartnerEvent_MM_MajorUpdate":                                         "Marketing Message Major Update",
	"PartnerEvent_MM_TitleTip":                                            "Make the title compelling and relevant for players. If this is truly one of the biggest updates of the year, the title should reflect that excitement. Avoid generic phrasing like <1>'Version 330.4 update.'</1> Instead, highlight what makes the update special.",
	"PartnerEvent_MM_ArtworkTip":                                          "The key art must clearly showcase the update itself. Do not simply reuse your game's standard artwork. Players should immediately recognize that this represents something new and significant.",
	"PartnerEvent_MM_DescriptionTip1":                                     "The event description should be thoughtfully built to explain the update and why it matters. Use this as your chance to bring players back into your game:",
	"PartnerEvent_MM_DescriptionTip2":                                     "Highlight the new and exciting content.",
	"PartnerEvent_MM_DescriptionTip3":                                     "Get creative with images, trailers, or short clips.",
	"PartnerEvent_MM_DescriptionTip4":                                     "Make the case for why players should care, return, and engage.",
	"PartnerEvent_MM_DescriptionTip5":                                     "This is your opportunity to sell the update, not just announce it.",
	"PartnerEvent_MM_LearnMore":                                           "Learn more about the Major Update pop-up marketing message here.",
	...
	"Login_SteamMobileApp_Step1":                                          "Step 1",
	"Login_SteamMobileApp_Step2":                                          "Step 2",
	"Login_SteamMobileApp_LoginOptions":                                   "Open the Steam Mobile App to the Steam Guard tab, then tap the gear.",
	"Login_MoreWaysToSignIn":                                              "More ways to sign in",
	"Login_MoreWaysToSignIn_SignInWithMobileApp":                          "Sign in with Mobile App",
	"Login_MoreWaysToSignIn_MobileAppTapToConfirm":                        "Mobile App - Tap to confirm",
	"Login_MoreWaysToSignIn_MobileAppScanQRCode":                          "Mobile App - Scan QR code",
	"Login_MoreWaysToSignIn_ShowQRCodeThroughHeadset":                     "Show QR code through headset",
	"Login_MoreWaysToSignIn_ManuallyEnterPassword":                        "Manually enter password",
	"Login_MoreWaysToSignIn_CreateSteamAccount":                           "Create Steam Account",
	"Login_SignInWithAccountName":                                         "Sign in with account name",
	"Login_OrUseSteamMobileApp":                                           "Or use the Steam Mobile App for more sign in options",
	"Login_Bluetooth_MatchImage":                                          "Ensure your mobile app shows this verification image.",
	...
	"Login_ConfirmCredentials":                                            "For security purposes, please confirm your account credentials.",
	...
	"Login_BLE_Starting":                                                  "Preparing for sign in",
	"Login_BLE_WaitingForApproval":                                        "Waiting for Steam Mobile App to approve sign in",
	"Login_BLE_WaitingForMobileApp":                                       "Open the Steam Mobile App.",
	"Login_BLE_SteamMobileAppAvailable":                                   "The Steam Mobile App is available for free in mobile device app stores.",
	"Login_BLE_SignInFailed":                                              "Sign in failed, try again.",
	"Login_Button_MoreOptions":                                            "More Options...",
	...
	"Chat_Settings_Error_ChatUploadFileTypeNotSupported":                  "Files of type '%1$s' are not supported.\\n\\nSome common supported image and video file types are: jpg, png, gif, webp, avif, mp4 and webm.",
	"Chat_Settings_Error_FileTypeNotZip":                                  "Files of type '%1$s' are not supported.\\n\\nMust be a zip file.",
	...
	"Sale_Bundle_CompletePartialSet":                                      "%1$s of %2$s items from this bundle are already in your library.",
	...
	"Sale_Ignore":                                                         "Ignore Game",
	"Sale_RemoveFromIgnored":                                              "Remove from ignore list",
	"Sale_AddToLibrary":                                                   "+ Add to Library",
	"Sale_SeeEventDetails":                                                "See Event Details",
	"Sale_AddToLibrary_NoPlus":                                            "Add to Library",
	"Sale_AddedToLibrary":                                                 "Added to Library",
	"Sale_AddToLibrary_DialogDesc":                                        "%1$s has been added to your account.",
	"Sale_AddToLibrary_DialogDesc2":                                       "Remote download to: %1$s",
	"Sale_AddToLibrary_RemoteDownload":                                    "You can start downloading to the following device:",
	"Sale_AddToLibrary_RemoteDownload_Device":                             "Download to device:",
	"Sale_AddToLibrary_DownloadStarted":                                   "Download started",
	"Sale_AddToLibrary_SeeDownloadProgress":                               "See progress on your games list",
	...
	"Sale_SaleEditor_JumpTo_ttip":                                         "Jump to this section in the sale page editor",
	"Sale_SaleEventIsHidden":                                              "This sale page is hidden to the public. You can see this page due to your account privileges.",
	"Sale_SaleEventIsHidden_Reason":                                       "Note:",
	"Sale_SaleEventIsHidden_Reason_Plural":                                "Notes:",
	"Sale_SaleEventIsHidden_Reason_ProductHide":                           "The 'Show on my Steam Store page' setting is turned off.",
	"Sale_SaleEventIsHidden_Reason_Mod":                                   "The 'Hide from Steam Store page (VO)' setting is turned on.",
	"Sale_SaleEventIsHidden_ContentHub_Preview":                           "This page is intended to be a content hub. This is a preview for the content hub.",
	"Sale_BroadcastSchedule":                                              "Broadcast Schedule",
	"Sale_TopPlayedOnDeckSection":                                         "Steam Deck Top Played Games",
	...
	"Sale_Creator_ListCount":                                              "%1$s items",
	"Sale_PersonalizedCarousel_Section_Editor_title":                      "Personalized Carousel (%1$s/%2$s)",
	"Sale_CreatorList_Section_Editor_title":                               "Creator List - %1$s",
	...
	"Sale_SmartPlaceHolder":                                               "Preview Mode: This automatically-populated section has no apps for you. This entire section and title would not appear on user's page if it is empty.",
	...
	"Sale_PersonalizedCarousel_Section_subtitle":                          "Because you've played games tagged with %1$s",
	...
	"Sale_ReserveNow_Change":                                              "Change Reservation",
	...
	"Sale_ReserveEditor_ReservePack":                                      "Purchasable or Reservable Package",
	...
	"Sale_ReserveEditor_SanPowerSupplyPackage":                            "Optional: Package without Power Supply",
	"Sale_ReserveEditor_SanPowerSupplyPackage_ttip":                       "To meet EU regulation, hardware should be purchaseable without power supply. If that package exists, supply it here.",
	"Sale_Reservations_BusyServer":                                        "Sorry, our servers are busy right now. Please try again in a few minutes.",
	"Sale_Section_TabUndefined":                                           "You must have at least two tabs defined. This section is currently hidden in publicly visible page.",
	"Sale_Section_TabsUnnamed":                                            "Your tabs must be named in order to be visible.",
	"Sale_AlreadyReserved":                                                "Reserved on %1$s",
	"Sale_AlreadyReserved_WithName":                                       "%1$s reserved on %2$s",
	"Sale_AlreadyReserved_NoDate":                                         "Reserved",
	"Sale_AlreadyReserved_WithName_NoDate":                                "%1$s reserved",
	...
	"Sale_default_label_Free_Promo_Description_Short":                     "Offer ends %1$s.",
	"Sale_default_Tooltip_Free_Promo_Limitation":                          "While supplies last. Games granted during free-to-keep promotions do not drop Steam Trading Cards.",
	...
	"Sale_BackgroundColorPicker":                                          "Choose Color From Screen",
	"Sale_EyeDropperError":                                                "Your browser does not support the EyeDropper API.",
	"Sale_EyeDropperFailed":                                               "Eyedropper cancelled or failed",
	...
	"Sale_default_label_270":                                              "Players Like You Wishlist",
	"Sale_default_label_271":                                              "Players Like You Play",
	"Sale_default_label_272":                                              "Limited Time Free-to-Keep",
	"Sale_default_label_273":                                              "Free-to-Keep",
	"Sale_default_label_274":                                              "Free In-Game Items",
	"Sale_default_label_275":                                              "Claim Free Items",
	"Sale_default_label_276":                                              "In-Game Items",
	"Sale_default_label_278":                                              "FAQ",
	"Sale_default_label_279":                                              "Questions and Answers",
	"Sale_default_label_280":                                              "All DLC",
	"Sale_default_label_281":                                              "Latest Releases",
	...
	"Sale_default_subtitle_6":                                             "Limited Time Offer",
	"Sale_default_subtitle_7":                                             "Join our playtest",
	"Sale_Section_PointShop_class_1":                                      "Badge",
	"Sale_Section_PointShop_class_2":                                      "Trading Cards",
	"Sale_Section_PointShop_class_3":                                      "Profile Background",
	"Sale_Section_PointShop_class_4":                                      "Emoticon",
	"Sale_Section_PointShop_class_5":                                      "Booster Pack",
	...
	"Sale_Section_PointShop_class_16":                                     "Keyboard Skin",
	"Sale_Section_PointShop_class_17":                                     "Startup Movie",
	...
	"Template_Block":                                                      "Tech Spec Group %1$s",
	...
	"Sale_Reservation_NotAvailale_PreDate":                                "Reservations are currently not available for customers who have not made a purchase on Steam before %1$s.",
	"Sale_Reservation_CannotReserveDueToOwnership_Generic":                "Reservations are currently not available for customers who have already purchased this item.",
	"Sale_Reservation_CannotReserveDueToOwnership_Specific":               "Reservations are currently not available for customers who have already purchased %1$s.",
	...
	"Sale_Reservation_CancelAreYouSure_NoDeposit":                         "By canceling your reservation you are giving up your spot in the queue. New reservations will put you at the end of the queue.",
	"Sale_Reservation_Change_NoDeposit_1":                                 "By changing your reservation you are Cancelling your original reservation for %1$s and giving up your spot in the queue.",
	"Sale_Reservation_Change_NoDeposit_1_Emphasis":                        "By changing your reservation you are <1>canceling your original reservation</1> for <2>%1$s</2> and giving up your spot in the queue.",
	"Sale_Reservation_Change_NoDeposit_2":                                 "Your new reservation for %1$s will put you at the end of the queue.",
	"Sale_Reservation_CompletePurchase":                                   "Complete purchase",
	"Sale_Reservation_CompleteBy":                                         "Complete purchase by:",
	"Sale_Reservation_CancelAuto":                                         "If you do not complete the purchase before the expiration time noted above, then we will cancel your reservation.",
	...
	"Sale_Reservation_Komodo_Generic":                                     "%1$s is available in Japan, South Korea, Taiwan, and Hong Kong via KOMODO at %2$s",
	"Sale_Reservation_Komodo_Generic_NoSk":                                "%1$s is available in Japan, Taiwan, and Hong Kong via KOMODO at %2$s",
	"Sale_Reservation_Too_Busy":                                           "Reservation Servers are busy, please try again",
	"Sale_Reservation_Available_Date":                                     "Available %1$s",
	"Sale_Reservation_AvailabilityUnknown":                                "No Availability Information Available",
	"Sale_Reservation_Fallback_V2":                                        "Customers will be emailed about purchase availability in the order their reservations were made.",
	"Sale_Reservation_Fallback_user_V2":                                   "We will email you when your reservation comes up in the queue, and may share additional updates along the way.",
	...
	"Sale_Reservation_ByYear":                                             "By %1$s",
	"Sale_Reservation_ByMonthYear":                                        "By %1$s, %2$s",
	"Sale_Reservation_BetweenNowAndLastDay":                               "Between now and %1$s %2$s, %3$s",
	...
	"Dummy":                                                               "Dummy",
	"Sale_BrowserSortOption_TopWishlisted":                                "Popular Upcoming",
	...
	"Sale_BrowserSortOption_MostPlayedDemo":                               "Top Demos",
	"Sale_BrowserSortOption_MostPlayedDemo_ttip":                          "Games sorted by their demo's all-time peak user count",
	"Sale_BrowserSortOption_DailyActiveUserDemo":                          "Top Demos",
	...
	"Sale_BrowserSortOption_RecentlyReleased":                             "New Releases",
	...
	"Sale_BrowserSortOption_TagRecommender":                               "Tag Recommender",
	"Sale_BrowserSortOption_TagRecommender_ttip":                          "Games featured on this sales page ordered by their original store tags matched against the recommended tags for the user.",
	"Sale_BrowserSortOption_PopularPurchasedDiscounted":                   "Popular Discounted",
	...
	"Sale_BrowserSortOption_TrendingFree":                                 "Trending Free",
	"Sale_BrowserSortOption_TrendingFree_ttip":                            "Free games ordered by released date that have evidence of customer interest. Used in the front page's trending free tab.",
	"Sale_BrowserSortOption_All":                                          "All",
	"Sale_BrowserSortOption_All_ttip":                                     "All the games featured in this sale ordered by descending Steam release date",
	"Sale_BrowserSortOption_MLWishlist":                                   "ML Wishlist Recommender",
	...
	"Sale_BrowserSortOption_MLPlaytime":                                   "ML Playtime Recommender",
	...
	"Sale_BrowserSortOption_ContentHub_Popular_GreatOnFrame":              "What's Being Played",
	"Sale_BrowserSortOption_ContentHub_Popular_GreatOnFrame_ttip":         "The most popular games right now based on number of players playing on Steam Frame",
	...
	"Sale_BrowserSortOption_AllReleased":                                  "Most Recent",
	"Sale_BrowserSortOption_AllReleased_ttip":                             "All released games ordered by descending Steam release date",
	"Sale_BrowserSortOption_AllUpcoming":                                  "Upcoming",
	"Sale_BrowserSortOption_AllUpcoming_ttip":                             "All upcoming games ordered by ascending Steam release date",
	"Sale_BrowserSortOption_ContentHub_Suffix":                            "Content Hub",
	"Sale_BrowserSortOption_Incompatible":                                 " - Incompatible with this event type",
	"Sale_ItemBrowser_ShowFromBeginning":                                  "Click here to view all matches from the beginning",
	"Sale_ItemBrowser_SearchPlaceholder":                                  "Search by name...",
	"Sale_ItemBrowser_ViewMode_SwitchToCompact":                           "Switch to compact view",
	"Sale_ItemBrowser_ViewMode_SwitchToExpanded":                          "Switch to expanded view",
	...
	"Sale_Bundle_Discount_ttip":                                           "This is what you save by buying these items together in the bundle",
	"Sale_Bundle_Discount_Limited_ttip":                                   "Right now, you save even more because one or more items in this bundle is on a limited time discount",
	...
	"Sale_CrossPromoSale_DefaultSectionTitle":                             "Cross-Promote Sale Page Section",
	"Sale_CrossPromoSale_SectionTitle":                                    "Games from sale event: %1$s",
	...
	"ReviewScore_UserReviewScoreAria":                                     "The review score is %1$s.",
	"ReviewScore_UserReviewScoreAria_LanguageSpecific":                    "The %2$s review score is %1$s.",
	"ReviewScore_UserReviewScore_LanguageSpecific":                        "%1$s Reviews: ",
	...
	"GotSteam_NeedSteam":                                                  "<1>Learn more</1> and download Steam.",
	"GrantAwardTitle":                                                     "Give an Award",
	"GrantAwardDescription_Review":                                        "Use your Steam Points to show your appreciation for this review.",
	"GrantAwardDescription_UGC":                                           "Use your Steam Points to show your appreciation for this item.",
	"GrantAwardDescription_Profile":                                       "Use your Steam Points to grant this profile a special award.",
	"GrantAwardDescription_ForumTopic":                                    "Use your Steam Points to show your appreciation for this discussion post.",
	"GrantAwardDescription_Comment":                                       "Use your Steam Points to show your appreciation for this comment.",
	...
	"RewardsReaction_24":                                                  "Winner",
	"RewardsReaction_25":                                                  "Beautiful",
	"RewardsReaction_26":                                                  "Helpful",
	"RewardsReaction_27":                                                  "Fire",
	"RewardsReaction_28":                                                  "Funny",
	"RewardsReaction_29":                                                  "One Hundred",
	"RewardsReaction_30":                                                  "Life Saver",
	"RewardsReaction_31":                                                  "Perfect",
	"RewardsReaction_32":                                                  "Plus One",
	"RewardsReaction_33":                                                  "Smart",
	"RewardsReaction_34":                                                  "Pure Gold",
	"RewardsReaction_35":                                                  "Wholesome",
	...
	"RewardsReaction_ToolTip_Granted":                                     "Given by 1 person.",
	"RewardsReaction_ToolTip_Granted_Plural":                              "Given by %1$s people.",
	"RewardsReaction_ToolTip_Points":                                      "Award gives creators %1$s Steam Points.",
	...
	"GameHover_UserReviewCount_Lang":                                      "%1$s %2$s Reviews",
	...
	"StreamLaunch_CaptureBusy":                                            "Streaming resources are in use by another stream or recording.",
	...
	"SteamMachine_TestResult_VRStreamingNotSupported":                                   "Streaming this VR game from Steam Machine is not supported",
	"SteamMachine_TestResult_VRStreamingIsPerformant":                                   "Streaming this VR game from Steam Machine performs well",
	"SteamMachine_TestResult_VRStreamingNotPerformant":                                  "This game requires manual configuration of graphics settings to perform well streaming from Steam Machine",
	"SteamMachine_TestResult_VRStreamingUnsupportedGraphicsPerformance":                 "This game's graphics settings cannot be configured to stream well from Steam Machine",
	...
	"SteamMachine_TestResult_DisplayOutputHasNonblockingIssues":                         "This game has minor graphics/display issues on Steam Machine",
	"SteamMachine_TestResult_AudioOutputHasNonblockingIssues":                           "This game has minor audio issues on Steam Machine",
	"SteamMachine_TestResult_DefaultControllerConfigFullyFunctional":                    "All functionality is accessible when using the default controller configuration",
	"SteamMachine_TestResult_ControllerGlyphsMatchDevice":                               "This game shows Steam controller icons",
	"SteamMachine_TestResult_DefaultConfigurationIsPerformant":                          "This game's default graphics configuration performs well on Steam Machine",
	"SteamMachine_TestResult_LauncherInteractionIssues":                                 "This game's launcher/setup tool may require the touchscreen or virtual keyboard",
	"SteamMachine_TestResult_DefaultConfigurationIsNotPerformant":                       "This game requires manual configuration of graphics settings to perform well on Steam Machine",
	"SteamMachine_TestResult_ControllerGlyphsDoNotMatchDevice":                          "This game sometimes shows mouse, keyboard, or non-Steam controller icons",
	"SteamMachine_TestResult_SteamOSDoesNotSupport":                                     "Valve is still working on adding support for this game on Steam Machine",
	"SteamMachine_TestResult_DefaultControllerConfigNotFullyFunctional":                 "Some functionality is not accessible when using the default controller configuration, requiring use of the touchscreen or virtual keyboard, or a community configuration",
	"SteamMachine_TestResult_TextInputDoesNotAutomaticallyInvokesKeyboard":              "Entering some text requires manually invoking the on-screen keyboard",
	"SteamMachine_TestResult_GameOrLauncherDoesntExitCleanly":                           "This game does not exit cleanly and may require you to manually quit via the Steam overlay",
	"SteamMachine_TestResult_VideoPlaybackHasNonblockingIssues":                         "Some in-game movie content may be missing or have playback issues",
	"SteamMachine_TestResult_SteamOSDoesNotSupport_Software":                            "This is a Software title and is not supported on Steam Machine",
	"SteamMachine_TestResult_SteamOSDoesNotSupport_Retired":                             "This game has been retired or is no longer in a playable state and is not supported on Steam Machine",
	"SteamMachine_TestResult_UnsupportedAntiCheat_Other":                                "This game is unsupported on Steam Machine due to use of an unsupported anti-cheat or multiplayer service",
	"SteamMachine_TestResult_UnsupportedAntiCheatConfiguration":                         "This game's anti-cheat is not configured to support Steam Machine",
	"SteamMachine_TestResult_UnsupportedGraphicsPerformance":                            "This game's graphics settings cannot be configured to run well on Steam Machine",
	"SteamMachine_TestResult_SteamOSDoesNotSupport_OperatingSystem":                     "This game requires an operating system that is not currently supported on Steam Machine",
	"SteamMachine_TestResult_FirstTimeSetupRequiresActiveInternetConnection":            "This game's first-time setup requires an active Internet connection",
	"SteamMachine_TestResult_SingleplayerGameplayRequiresActiveInternetConnection":      "Singleplayer gameplay requires an active Internet connection",
	"SteamMachine_TestResult_CrossPlatformCloudSavesNotSupported":                       "This game does not support cross-platform saved games",
	"SteamMachine_TestResult_SimultaneousInputGyroTrackpadFriendly":                     "This game supports using the gyro/trackpad in mouse mode for camera controls with gamepad controls for movement",
	"SteamMachine_TestResult_HDRMustBeManuallyEnabled":                                  "This game supports HDR but it must be manually enabled using in-game settings",
	"SteamMachine_TestResult_MultiWindowAppAutomaticallySetsFocus":                      "This game uses multiple windows and may require you to focus the appropriate windows manually via the Steam overlay",
	...
	"SteamMachineVerified_DescriptionHeader":                                            "Valve’s testing indicates this title is %1$s on Steam Machine. %2$s",
	"SteamMachineVerified_DescriptionHeader_WithAppName":                                "Valve’s testing indicates that %1$s is %2$s on Steam Machine. %3$s",
	"SteamMachineVerified_DescriptionHeader_Verified":                                   "This game is fully functional on Steam Machine.",
	"SteamMachineVerified_DescriptionHeader_Playable":                                   "This game is functional on Steam Machine, but might require extra effort to interact with or configure.",
	"SteamMachineVerified_DescriptionHeader_Unsupported":                                "Some or all of this game currently doesn't function on Steam Machine.",
	"SteamMachineVerified_DescriptionHeader_Unknown":                                    "Valve is still learning about this title. We do not currently have further information regarding Steam Machine compatibility.",
	"SteamMachineVerified_DescriptionHeader_Unknown_WithAppName":                        "Valve is still learning about %1$s. We do not currently have further information regarding Steam Machine compatibility.",
	"SteamMachineVerified_DescriptionHeader_DeveloperBlog":                              "The developer has provided additional information regarding Steam Machine support for this game. Learn more on their Community Page by pressing",
	"SteamMachineVerified_DescriptionHeader_DeveloperBlog_Desktop":                      "The developer has provided additional information regarding Steam Machine support for this game. Learn more on their Community Page.",
	"SteamOS_DescriptionHeader_DeveloperBlog":                                           "The developer has provided additional information regarding SteamOS support for this game. Learn more on their Community Page by pressing",
	"SteamOS_DescriptionHeader_DeveloperBlog_Desktop":                                   "The developer has provided additional information regarding SteamOS support for this game. Learn more on their Community Page.",
	...
	"SteamDeckVerified_DisagreeDialog_Title":                                            "Why should this title not be Verified?",
	"SteamDeckVerified_DisagreeDialog_OK":                                               "Submit",
	"SteamDeckVerified_DisagreeDialog_Performance":                                      "Performance",
	"SteamDeckVerified_DisagreeDialog_Legibility":                                       "Legibility",
	"SteamDeckVerified_DisagreeDialog_Stability":                                        "Stability",
	"SteamDeckVerified_DisagreeDialog_Input":                                            "Input",
	"SteamDeckVerified_DisagreeDialog_Other":                                            "Other",
	...
	"GameFrameRateReporting_Question":                                                   "Can we collect anonymized gameplay frame rate data, to improve SteamOS devices for all players? You can change this later in Settings.",
	"GameFrameRateReporting_Response_Yes":                                               "Yes",
	"GameFrameRateReporting_Response_No":                                                "No Thanks",
	"GameFrameRateReporting_Confirmation_Yes":                                           "Thanks, you can change this at any time in account settings.",
	"GameFrameRateReporting_Confirmation_No":                                            "You can change this at any time in account settings.",
	...
	"SteamOSCompatibility_Store_CompatSectionHeader_GamepadUI":                          "SteamOS Compatibility",
	"SteamMachineCompatibility_Store_CompatSectionHeader_GamepadUI":                     "Steam Machine Compatibility",
	"SteamFrameCompatibility_Store_CompatSectionHeader_GamepadUI":                       "Steam Frame Compatibility",
	...
	"SteamFrame_TestResult_UnsupportedAntiCheatConfiguration":                           "This game's anti-cheat is not configured to support Steam Frame",
	"SteamFrame_TestResult_UnsupportedAntiCheat_Other":                                  "This game is unsupported on Steam Frame due to use of an unsupported anti-cheat or multiplayer service",
	"SteamFrame_TestResult_SteamOSDoesNotSupport":                                       "Valve is still working on adding support for this game on Steam Frame",
	"SteamFrame_TestResult_SteamOSDoesNotSupport_Retired":                               "This game has been retired or is no longer in a playable state and is not supported on Steam Frame",
	"SteamFrame_TestResult_SteamOSDoesNotSupport_OperatingSystem":                       "This game requires an operating system that is not currently supported on Steam Frame",
	"SteamFrame_TestResult_LauncherInteractionIssues":                                   "This game's launcher/setup tool may require the virtual keyboard, or have difficult to read text",
	"SteamFrame_TestResult_GameOrLauncherDoesntExitCleanly":                             "This game does not exit cleanly and may require you to manually quit via the Steam overlay",
	"SteamFrame_TestResult_DeviceCompatibilityWarningsShown":                            "This game displays compatibility warnings when running on Steam Frame, but runs fine",
	"SteamFrame_TestResult_DisplayOutputNotCorrectlyScaled":                             "This game is incorrectly scaled on Steam Frame and may require you to configure the display resolution manually",
	"SteamFrame_TestResult_AuxFunctionalityNotAccessible_MapEditor":                     "Some auxilliary functionality is not accessible on Steam Frame: map editor",
	"SteamFrame_TestResult_ExternalControllersNotSupportedPrimaryPlayer":                "This game does not default to external Bluetooth/USB controllers on Steam Frame, and may require manually switching the active controller via the Quick Access Menu",
	"SteamFrame_TestResult_VideoPlaybackHasNonblockingIssues":                           "Some in-game movie content may be missing or have playback issues",
	"SteamFrame_TestResult_AudioOutputHasNonblockingIssues":                             "This game has minor audio issues on Steam Frame",
	"SteamFrame_TestResult_TextInputDoesNotAutomaticallyInvokesKeyboard":                "Entering some text requires manually invoking the on-screen keyboard",
	"SteamFrame_TestResult_DisplayOutputHasNonblockingIssues":                           "This game has minor graphics/display issues on Steam Frame",
	"SteamFrame_TestResult_ResumeFromSleepNotFunctional":                                "This game may experience temporary issues after sleeping on Steam Frame",
	"SteamFrame_TestResult_MultiWindowAppAutomaticallySetsFocus":                        "This game uses multiple windows and may require you to focus the appropriate windows manually via the Steam overlay",
	"SteamFrame_TestResult_DefaultControllerConfigFullyFunctional":                      "All functionality is accessible when using the default controller configuration",
	"SteamFrame_TestResult_DefaultControllerConfigNotFullyFunctional":                   "Some functionality is not accessible when using the default controller configuration, requiring use of the virtual keyboard, or a community configuration",
	"SteamFrame_TestResult_GamepadNotEnabledByDefault":                                  "This game requires manually enabling controller support using in-game settings",
	"SteamFrame_TestResult_NotFullyFunctionalWithoutExternalKeyboard":                   "Parts of this game would benefit from using an external keyboard",
	"SteamFrame_TestResult_ControllerGlyphsMatchDevice":                                 "This game shows Steam Frame controller icons",
	"SteamFrame_TestResult_ControllerGlyphsDoNotMatchDevice":                            "This game sometimes shows mouse, keyboard, or non-Steam-Frame controller icons",
	"SteamFrame_TestResult_SimultaneousInputGyroTrackpadFriendly":                       "This game supports using the gyro/trackpad in mouse mode for camera controls with gamepad controls for movement",
	"SteamFrame_TestResult_CrossPlatformCloudSavesNotSupported":                         "This game does not support cross-platform saved games",
	"SteamFrame_TestResult_CloudSavesNotEnabledByDefault":                               "This game requires manually enabling Steam Cloud support for saved games using in-game settings",
	"SteamFrame_TestResult_FirstTimeSetupRequiresActiveInternetConnection":              "This game's first-time setup requires an active Internet connection",
	"SteamFrame_TestResult_SingleplayerGameplayRequiresActiveInternetConnection":        "Singleplayer gameplay requires an active Internet connection",
	"SteamFrame_TestResult_DefaultConfigurationIsNotPerformant":                         "This game requires manual configuration of graphics settings to perform well on Steam Frame",
	"SteamFrame_TestResult_UnsupportedGraphicsPerformance":                              "This game's graphics settings cannot be configured to run well on Steam Frame",
	"SteamFrame_TestResult_NativeResolutionNotDefault":                                  "This game supports Steam Frame's native display resolution but does not set it by default and may require you to configure the display resolution manually",
	"SteamFrame_TestResult_NativeResolutionNotSupported":                                "This game doesn't support Steam Frame's native display resolution and may experience degraded performance",
	"SteamFrame_TestResult_InterfaceTextIsLegible":                                      "In-game interface text is legible on Steam Frame",
	"SteamFrame_TestResult_InterfaceTextIsNotLegible":                                   "Some in-game text is small and may be difficult to read",
	"SteamFrame_TestResult_DefaultConfigurationIsPerformant":                            "This game's default graphics configuration performs well on Steam Frame",
	"SteamFrameVerified_DescriptionHeader":                                              "Valve’s testing indicates this title is %1$s on Steam Frame. %2$s",
	"SteamFrameVerified_DescriptionHeader_WithAppName":                                  "Valve’s testing indicates that %1$s is %2$s on Steam Frame. %3$s",
	"SteamFrameVerified_DescriptionHeader_Unknown":                                      "Valve is still learning about this title. We do not currently have further information regarding Steam Frame compatibility.",
	"SteamFrameVerified_DescriptionHeader_Unknown_WithAppName":                          "Valve is still learning about %1$s. We do not currently have further information regarding Steam Frame compatibility.",
	"SteamFrameVerified_DescriptionHeader_Verified":                                     "This game is fully functional on Steam Frame.",
	"SteamFrameVerified_DescriptionHeader_Playable":                                     "This game is functional on Steam Frame, but might require extra effort to interact with or configure.",
	"SteamFrameVerified_DescriptionHeader_Unsupported":                                  "Some or all of this game currently doesn't function on Steam Frame.",
	...
	"DiscoveryQueue_ClassicQueue_Link":                                                  "Looking for the Classic Discovery Queue? <1>Click Here</1>",
	...
	"DiscoveryQueue_WidgetHeader_Yours":                                                 "Explore Your Discovery Queue",
	"DiscoveryQueue_WidgetHeader":                                                       "Click to open your queue of top-selling, new, and recommended titles",
	"DiscoveryQueue_WidgetHeader_LoggedOut":                                             "Sign in to discover top-selling, new and recommended titles.",
	"DiscoveryQueue_LaunchAction":                                                       "Launch Discovery Queue",
	"DiscoveryQueue_OpenAction":                                                         "Click to Open Your Discovery Queue",
	...
	"DiscoveryQueue_Widget_SaleTitle":                                                   "Now through %1$s",
	"DiscoveryQueue_Widget_SaleDesc":                                                    "Earn free stickers by going through your discovery queue!",
	"DiscoveryQueue_SaleStatus_Title":                                                   "You've earned %1$s %2$s stickers!",
	"DiscoveryQueue_SaleStatus_Title_Complete":                                          "You've earned all %1$s %2$s stickers!",
	"DiscoveryQueue_SaleStatus_Desc":                                                    "Get %1$s more free stickers by going through your queue again",
	"DiscoveryQueue_SaleStatus_Link":                                                    "View your stickers",
	...
	"SaleTrailerCarousel_AddToWishlist":                                                 "Wishlist",
	"SaleTrailerCarousel_ViewStorePage":                                                 "View store page",
	"SaleTrailerCarousel_RemoveFromWishlist":                                            "Unwishlist",
	"SaleTrailerCarousel_IgnoreLink_ttip":                                               "Ignore: Mark this game as ignored to hide it from most places in the Steam store.",
	"SaleTrailerCarousel_Ignored":                                                       "Ignored",
	"SaleTrailerCarousel_IgnoredConfirmation":                                           "We'll never show you this game again",
	"SaleTrailerCarousel_Undo":                                                          "Undo",
	"SaleTrailerCarousel_PlayPause":                                                     "Play / Pause",
	"SaleTrailerCarousel_NextGameInSeconds":                                             "Next Game in %1$s second...",
	"SaleTrailerCarousel_NextGameInSeconds_Plural":                                      "Next Game in %1$s seconds...",
	"SaleTrailerCarousel_AutoAdvanceVideoPaused":                                        "Video paused",
	"SaleTrailerCarousel_AutoAdvanceHover":                                              "Paused while mouse is hovering",
	"SaleTrailerCarousel_AutoAdvanceEnabled":                                            "Auto Advance",
	"StoreTrailer_Title_Combiner":                                                       "%1$s | %2$s",
	"StoreTrailer_Title_TrailerPreview":                                                 "Trailer Preview",
	"StoreTrailer_AOWarning_1":                                                          "This trailer is paused because it may contain adult-only content.",
	"StoreTrailer_AOWarning_2":                                                          "If you want to watch, just click play and we'll remember your preference for this session.",
	"GameHighlight_Theater_Header":                                                      "%1$s - Trailers & Screenshots",
	"GameHighlight_Theater_ItemCount":                                                   "%1$s of %2$s",
	...
	"MediaConvert_InternalError":                                                        "An unexpected error occurred during processing. Please try again later.",
	"MediaConvert_InputError_Unsupported_Input":                                         "The input file type is not supported. Please provide a valid media file.",
	"MediaConvert_InputError_TooLongVideo":                                              "The animation or video exceeds the maximum allowed duration. Please upload a shorter animation or video.",
	"MediaConvert_FailToCreatePoster":                                                   "Failed to create poster image for your animation or video.",
	"MediaConvert_FailToCreate_All":                                                     "Media processing failed. Please re-encode your file and try again.",
	"MediaConvert_InputError_NonAudio_Input":                                            "The input file does not contain any audio stream. Please provide a file with an audio track.",
	"MediaConvert_AnimatedWebP_NoSupport":                                               "Do not support animated WebP file as input file",
	"MediaConvert_InputError_DimensionsDontMatchRequirements":                           "Input media doesn't match require dimensions",
	"MediaConvert_InputError_GifParsingError":                                           "Failed to Parse GIF. Please re-encode or change format type and try again.",
	"MediaConvert_InputError_ImageTooSmall":                                             "The image is too small. Please upload an image at least 16x16 pixels.",
	"MediaConvert_InputError_AnimationTooSmall":                                         "The animation or video is too small. Please upload an animation or video at least 16x16 pixels.",
	"MediaConvert_InputError_ImageTypeWithAudio":                                        "Image files cannot contain an audio track.",
	"MediaConvert_InputError_NoAvif_NotSupported_WithVideo":                             "AVIF output is not supported for video sources.",
	"MediaConvert_InternalError_FailedToConvert":                                        "Failed to convert this file. Please re-encode file before trying again.",
	"MediaConvert_CloudUpload_ErrorFileType":                                            "Invalid or missing file extension; unable to determine file type (mimetype). Please upload a file with a valid extension.",
	"MediaConvert_CloudUpload_UploadError":                                              "Something went wrong while uploading your file. Please try again in a few minutes.",
	...
	"ReorderableList_ReorderInstructions":                                               "Select and move up or down to reorder",
	...
	"ImagePicker_Localized":                                                             "Edit localization",
	...
	"ImageUpload_Waiting":                                                               "Waiting to upload",
	"ImageUpload_Uploading":                                                             "Uploading",
	"ImageUpload_Processing":                                                            "Processing",
	...
	"ImageUpload_PreferredDimension":                                                    "While the current image size is acceptable, the preferred dimensions are %1$sx%2$s",
	...
	"ImageUpload_InvalidResolution":                                                     "The new images for %1$s are different sizes than the ones already there.",
	"ImageUpload_MismatchedResolution":                                                  "The new images for %1$s have differing sizes.",
	"ImageUpload_InvalidFileType":                                                       "The file type is not supported for this asset.",
	"ImageUpload_EmptyBaseName":                                                         "The base asset name could not be determined. See note above about file names and languages.",
	"ImageUpload_ReplaceLanguage":                                                       "This image will replace the %1$s version.",
	"ImageUpload_ExceedsMaxFileSize":                                                    "Exceeds max file size of %1$s",
	"ImageUpload_CropPreview":                                                           "Final image",
	"ImageUpload_LocalizedAssets":                                                       "Uploaded Languages",
	"ImageUpload_ImageGroup":                                                            "Localized image group",
	"ImageUpload_ImageGroup_ttip":                                                       "The group of images that will contain this image upon upload. We try to autodetect the image language based on the suffix of the image filename, e.g. myimage_english.jpg. You can use this dropdown to override which other images this gets grouped with.",
	"ImageUpload_Deprecated":                                                            "(Legacy)",
	"ImageUpload_Deprecated_ttip":                                                       "This resolution is still supported for now, but it is no longer the preferred size for this artwork.",
	"ImageDisplay_NoAssetUploaded":                                                      "No Assets Uploaded",
	"ImageDisplay_ShowAllAssets":                                                        "Show all %1$s language assets",
	"ImageDisplay_EditAltText":                                                          "Alt text: Please describe what is happening and shown in the image above for players that use screen readers.",
	...
	"UserGameNotes_ErrorSavingNotes":                                                    "There was an error saving changes to this note: %1$s",
	"UserGameNotes_NotesForGame":                                                        "Notes for %1$s",
	"UserGameNotes_PinWindow":                                                           "Pin window to game",
	"UserGameNotes_FlipWindow":                                                          "Flip window so that the title bar is on the bottom",
	...
	"FormattingToolbar_EditLink":                                                        "Edit Link",
	...
	"FormattingToolbar_Color":                                                           "Color",
	"FormattingToolbar_BgColor":                                                         "Background Color",
	"FormattingToolbar_AlignLeft":                                                       "Align Left",
	"FormattingToolbar_AlignCenter":                                                     "Align Center",
	"FormattingToolbar_AlignRight":                                                      "Align Right",
	"FormattingToolbar_FullWidth":                                                       "Uses all available space; changing the size of the font to fit",
	"FormattingToolbar_BulletedList":                                                    "Bulleted List",
	"FormattingToolbar_OrderedList":                                                     "Ordered List",
	...
	"FormattingToolbar_Tables_InsertTable":                                              "Insert Table",
	"FormattingToolbar_Tables_AddRowBefore":                                             "Insert Row Above",
	"FormattingToolbar_Tables_AddRowAfter":                                              "Insert Row Below",
	"FormattingToolbar_Tables_DeleteRow":                                                "Delete Row",
	"FormattingToolbar_Tables_AddColumnBefore":                                          "Insert Column to the Left",
	"FormattingToolbar_Tables_AddColumnAfter":                                           "Insert Column to the Right",
	"FormattingToolbar_Tables_DeleteColumn":                                             "Delete Column",
	"FormattingToolbar_Tables_HeaderRow":                                                "Toggle Header Row",
	"FormattingToolbar_Tables_HeaderColumn":                                             "Toggle Header Column",
	"FormattingToolbar_Tables_HeaderCell":                                               "Toggle Header Cell",
	"FormattingToolbar_Tables_MergeCells":                                               "Merge Into a Single Cell",
	"FormattingToolbar_Tables_SplitCells":                                               "Split Merged Cells",
	"Prosemirror_FileUpload_DropFile":                                                   "Drop an image file to upload",
	"Prosemirror_FileUpload_Uploading":                                                  "Uploading and Processing",
	...
	"ServerBrowser_AddServerByIP":                                                       "Add server by IP",
	...
	"SteamNotificationTypeDesc_28":                                                      "I receive an invite to a Playtest or Limited Launch",
	"SteamNotificationGroupDesc_0":                                                      "Other Notifications",
	"SteamNotificationGroupDesc_1":                                                      "Store News",
	"SteamNotificationGroupDesc_2":                                                      "Developer / Game News",
	"SteamNotificationGroupDesc_3":                                                      "Steam Family Activity",
	"SteamNotificationGroupDesc_4":                                                      "Wishlist Activity",
	"SteamNotificationGroupDesc_5":                                                      "Personal Activity",
	"Email_OptOut_Send_WishlistItemDiscount":                                            "A discount is applied to an item on my wishlist",
	"Email_OptOut_Send_SeasonalPromo":                                                   "A seasonal promotion is beginning",
	"Email_OptOut_Send_WishlistItemRelease":                                             "An item on my wishlist has released (including full release or Early Access), or has transitioned from Early Access to full release",
	"Email_OptOut_Send_WishlistItemDemoRelease":                                         "A demo for an item on my wishlist has released",
	"Email_OptOut_Send_CreatorHomeItemRelease":                                          "A publisher or developer I followed has released (including full release or Early Access), or has transitioned from Early Access to full release",
	"Email_OptOut_Send_CreatorHomeItemDemoRelease":                                      "A publisher or developer I followed has released a demo",
	"Email_OptOut_Send_CuratorConnect":                                                  "A developer on Steam sends a review copy of a game or application to a Steam Curator group that I'm a part of",
	"Email_OptOut_Send_InLibraryEvents":                                                 "Game-specific event notifications",
	"Email_OptOut_Send_PartnerMessages":                                                 "New Steamworks features are announced or sales events are available",
	"Email_OptOut_Send_LoyaltyAwardsReceived":                                           "I receive Steam Community Awards",
	"Email_OptOut_Send_YearInReview":                                                    "My annual Steam Replay is now available",
	"Email_OptOut_Send_SeasonPassShip":                                                  "A season pass I own ships new content",
	"Email_OptOut_Send_RoadmapShip":                                                     "A game I follow has shipped new content from their roadmap",
	"Email_OptOut_Send_PartnerMessages_Desc":                                            "The Steam business team occasionally sends emails about new Steam features that developers can make use of, as well as invitations to participate in themed or seasonal sales. This setting only applied to accounts that are a member of a developer or publisher in Steamworks.",
	"Email_OptOut_Send_InLibraryEvents_Desc":                                            "Steam occasionally sends event reminders for specific games in your Steam library or that you follow. You can opt out of notifications from individual games by marking 'ignore' on their store page, or by adding it on the page below, or by following the opt-out link from the game's event email.",
	"Email_OptOut_Send_InLibraryEvents_Desc2":                                           "<1>Click here</1> to see the games you've ignored.",
	"Email_OptOut_Send_PerAppPerClan_Desc":                                              "You've opted out of receiving emails from %1$s games and from %2$s developer/publishers/franchises.",
	"Email_OptOut_Send_PageLink":                                                        "<1>Click here</1> to see the opt-out lists for games and developers/publishers/franchises.",
	"Email_OptOut_EmailOnly":                                                            "Opt out from all email marketing communications",
	"Email_OptOut_FooterNotes":                                                          "You will still receive purchase receipts, Steam Guard access codes, and other account-related notifications.",
	"Email_OptOut_UnableToOptOut":                                                       "This type of email cannot be disabled",
	"Email_OptOut_PreferencesForEmail":                                                  "Notification Settings for %1$s",
	"Account_Notification_Settings_Header_Notifyvia":                                    "Notify me via",
	"Account_Notification_Settings_Header_Email":                                        "Email",
	"Account_Notification_Settings_Header_Desktop":                                      "Client Toast",
	"Account_Notification_Settings_Header_Desktop_Short":                                "Toast",
	"Account_Notification_Settings_Header_Feed":                                         "Feed",
	"Account_Notification_Settings_Header_Mobile":                                       "Mobile App",
	"Account_Notification_Settings_Header_Mobile_Short":                                 "Mobile",
	"Account_Notification_Settings_Header_Unknown":                                      "Unknown",
	"Account_Notification_Settings_Feed_Tooltip":                                        "Notifications that appear in the notification bell at the top of the Steam Client",
	"Account_Notification_Settings_Mobile_Tooltip":                                      "Push notifications in the mobile app",
	"Account_Notification_Settings_Desktop_Tooltip":                                     "Toasts that appear on the computer the Steam Client is running on",
	"Account_Notification_Settings_Feed_Disabled":                                       "Feed is automatically enabled when Toast or Mobile are enabled",
	"Account_Notification_Settings_Wishlist_Categories":                                 "Only notify me about these wishlist categories",
	...
	"Notification_PlaytestInviteTitle":                                                  "Playtest Invite",
	"Notification_PlaytestInviteBody":                                                   "A friend has invited you to join a Steam Playtest!",
	"Notification_LimitedLaunchInviteTitle":                                             "Limited Launch Invite",
	"Notification_LimitedLaunchInviteBody":                                              "A friend has invited you to join a Limited Launch release!",
	"Notification_ReportedContentAction_Received":                                       "Your content report has been received.",
	"Notification_ReportedContentAction_Sanctioned":                                     "Your content report has been reviewed.",
	"Notification_ReportedContentAction_Acquitted":                                      "Your content report has been reviewed.",
	"Notification_ReportedContentAction_DisputeReceived":                                "Your dispute of a moderation decision has been received.",
	"Notification_ReportedContentAction_DisputeSanctioned":                              "Your dispute of a moderation decision has been reviewed.",
	"Notification_ReportedContentAction_DisputeAcquitted":                               "Your dispute of a moderation decision has been reviewed.",
	"Notification_ReportedContentAction_Unknown":                                        "(Unknown)",
	...
	"StoreApp_SeeAll":                                                                   "See All",
	"StoreApp_FollowCreator":                                                            "Follow %1$s",
	"StoreApp_FollowCreatorSubtitle":                                                    "And get notified of future releases",
	...
	"SteamNotifications_RequestedGameAddedTitle":                                        "Game added",
	...
	"Featured_App_None":                                                                 "<Not Highlighted>",
	"Featured_App_Name":                                                                 "Highlight This Item:",
	"Featured_App_Tooltip":                                                              "By setting a highlight reason, we will expand the capsule to be wider with more information and action buttons.",
	"Featured_App_Reason_Next":                                                          "Next in Series",
	"Featured_App_Reason_Franchise":                                                     "From The Franchise",
	"Featured_App_Reason_Similar":                                                       "Similar Game",
	"Featured_App_Reason_Upcoming":                                                      "Wishlist Now",
	"Featured_App_Reason_YouMight":                                                      "You Might Also Like",
	"Featured_App_Reason_LatestEdition":                                                 "Latest Edition",
	...
	"FamilyHistory_FamilyCooldownOverridesChanged":                                      "%1$s overrode the family cooldown period (new value: %2$s).",
	...
	"FamilyManagement_Members":                                                          "Family Members",
	...
	"FamilyManagement_ErrorLimitExceeded":                                               "This family is currently on cooldown until %1$s and can only accept or invite former members.",
	"FamilyManagement_ErrorFamilySizeLimitExceeded":                                     "This family is full and cannot accept or invite new members.",
	"FamilyManagement_ErrorAccountActivityLimitExceeded":                                "Your account is currently on cooldown until %1$s and can only rejoin your previous family.",
	"FamilyManagement_LoadingPlaceholder":                                               "(Loading...)",
	...
	"FamilyManagement_RegionLocked_JoinFamily":                                          "Based on your purchase history you appear to be in a different country than other members of this Steam Family.",
	...
	"Tour_TipCount":                                                                     "Tip: %1$s of %2$s",
	"ImagePickerLoc_DismissWarning":                                                     "You have one or more images not yet uploaded.",
	"Hardware_ShippingEstimate_Range":                                                   "%1$s-%2$s Business Days",
	"Settings_Hotkey_ToggleOverlay":                                                     "Toggle the Steam Overlay",
	"Settings_Hotkey_TakeScreenshot":                                                    "Take a screenshot",
	"Settings_Hotkey_TakeInstantClip":                                                   "Clip the last %1$s seconds of gameplay",
	"MeetSteam_Max":                                                                     "Max %1$s",
	"MeetSteam_Registered":                                                              "Registered",
	"MeetSteam_Already":                                                                 "Registered at another time",
	"MeetSteam_Registering":                                                             "Registering...",
	"MeetSteam_Unegistering":                                                            "Unregistering...",
	"MeetSteam_CompleteRegistration":                                                    "Complete Registration...",
	"MeetSteam_CompleteRegistration_Desc":                                               "Click here to fill in your details and complete the registration process:",
	"MeetSteam_UpdateRegistration":                                                      "Update Registration",
	"MeetSteam_UpdateRegistration_Desc":                                                 "Click here to update your registration with your new session selections:",
	"MeetSteam_RegistrationFailed":                                                      "We were unable to register you for some sessions. Please try again.",
	"MeetSteam_Spot":                                                                    "1 spot available",
	"MeetSteam_Spot_Plural":                                                             "%1$s spots available",
	"MeetSteam_SoldOut":                                                                 "Session Full",
	"MeetSteam_Reg_Preset":                                                              "Steamworks Partner",
	"MeetSteam_Reg_Preset_ttip":                                                         "We'll automatically fill in details based on your selected partner",
	"MeetSteam_Reg_Name":                                                                "Your Full Name",
	"MeetSteam_Reg_Email":                                                               "Contact Email",
	"MeetSteam_Reg_Company":                                                             "Company Name",
	"MeetSteam_Reg_Game":                                                                "Notable Game Name",
	"MeetSteam_Reg_Others":                                                              "Please let us know who else is coming. If you want to bring additional people with you, it's preferable to send them the invite link so they can register, see their registration, and get reminders.",
	"MeetSteam_Reg_Others_name":                                                         "Their Full Name",
	"MeetSteam_Reg_GuestCount":                                                          "Additional guests",
	"MeetSteam_Reg_GuestCount_ttip":                                                     "If you want to bring additional people with you, it's preferable to send them the invite link so they can register, see their registration, and get reminders. If you are only registering for yourself, leave this set to zero.",
	"MeetSteam_Reg_Intro":                                                               "Please fill in the information below to complete or modify your registration. Once registered, we'll send you a confirmation email as well as a reminder.",
	"MeetSteam_Session_Audience":                                                        "Audience: %1$s",
	"MeetSteam_Session_Details":                                                         "Session Description",
	"MeetSteam_AlreadyReg":                                                              "You've already registered for this topic at a different time: %1$s @ %2$s",
	"MeetSteam_FAQ":                                                                     "Frequently Asked Questions",
	"MeetSteam_Register_title":                                                          "Register for %1$s",
	"MeetSteam_Unregister_title":                                                        "Unregister from session?",
	"MeetSteam_ChoosePartner":                                                           "(Choose a partner)",
	"MeetSteam_ChoosePartnerOther":                                                      "Other...",
	"MeetSteam_Reg_Question_title":                                                      "Do you have specific topics or questions you’d like us to cover?",
	"MeetSteam_Reg_Question_desc":                                                       "Help the Steam team prepare the most productive session by letting us know anything in particular you’d like to know more about.",
	"MeetSteam_Reg_Question_placeholder":                                                "Enter any particular topics you'd like to cover during the session",
	"MeetSteam_QR_CheckIn":                                                              "You're Registered! Here is the QR Code to speed up check-in at the event.",
	"MeetSteam_Or":                                                                      "Or",
	"StoreAdmin_SocialMedia_EnterLink":                                                  "Enter the link",
	"StoreAdmin_SocialMedia_EnterNumber":                                                "Enter the group number",
	"StoreAdmin_SocialMedia_EnterName":                                                  "Enter the group name",
	"StoreAdmin_SocialMedia_Add":                                                        "Choose social media to add",
	"StoreAdmin_SocialMedia_ValidationPrefix":                                           "This entry must start with one of: %1$s",
	"StoreAdmin_SocialMedia_ValidationNumber":                                           "This entry must be a number",
	"StoreAdmin_SocialMedia_ValidationText":                                             "This entry is the group name (not a link)",
	"StoreAdmin_SocialMedia_ValidationTumblr":                                           "This entry must be in the format: https://<name>.tumblr.com",
	"StoreAdmin_SocialMedia_ValidationMastodon":                                         "This entry must start with one of: %1$s. If your instance is not listed, you can use this link format: https://mastodon.social/@<username>@<yourinstance> ",
	...
	"StoreAdmin_SocialMedia_Type_qq":                                                    "QQ number",
	"StoreAdmin_SocialMedia_Type_qqlink":                                                "QQ link",
	"StoreAdmin_SocialMedia_Type_qqchannel":                                             "QQ channel",
	...
	"ControllerButton_A":                                                                "A Button",
	"ControllerButton_B":                                                                "B Button",
	"ControllerButton_X":                                                                "X Button",
	"ControllerButton_Y":                                                                "Y Button",
	"ControllerButton_DpadLeft":                                                         "Dpad Left",
	"ControllerButton_DpadRight":                                                        "Dpad Right",
	"ControllerButton_DpadUp":                                                           "Dpad Up",
	"ControllerButton_DpadDown":                                                         "Dpad Down",
	"ControllerButton_Steam":                                                            "Steam Button",
	"ControllerButton_QAM":                                                              "Quick Access Menu Button",
	"ControllerButton_View":                                                             "View Button",
	"ControllerButton_Menu":                                                             "Menu Button",
	"ControllerButton_L1":                                                               "L1 Button",
	"ControllerButton_R1":                                                               "R1 Button",
	"ControllerButton_L2":                                                               "L2",
	"ControllerButton_R2":                                                               "R2",
	"ControllerButton_LS":                                                               "Left Joystick",
	"ControllerButton_RS":                                                               "Right Joystick",
	"ControllerButton_L3":                                                               "L3 Click",
	"ControllerButton_R3":                                                               "R3 Click",
	"ControllerButton_LPad":                                                             "Left Trackpad",
	"ControllerButton_RPad":                                                             "Right Trackpad",
	"ControllerButton_LPad_Click":                                                       "Left Trackpad Click",
	"ControllerButton_RPad_Click":                                                       "Right Trackpad Click",
	"ControllerButton_L4":                                                               "L4 Button",
	"ControllerButton_R4":                                                               "R4 Button",
	"ControllerButton_L5":                                                               "L5 Button",
	"ControllerButton_R5":                                                               "R5 Button",
	"ControllerButton_Default":                                                          "Button",
	"ControllerButton_PlayStation":                                                      "PlayStation Button",
	"ControllerButton_Xbox":                                                             "Xbox Button",
	"ControllerButton_8BitDo":                                                           "8BitdDo Button",
	"ControllerButton_Home":                                                             "Home Button",
	"text_store_follow_desc":                                                            "Follow this item to see announcements in your community activity feed",
	"steam_curator_follow_ttip":                                                         "Follow this Steam Curator to be notified of future reviews. Reviews can appear in the featured spot on your Steam homepage and in your community activity feed",
	"steam_group_follow_ttip":                                                           "Follow this group to be notified of future news and announcements.",
	"Discount_ARIA_Label":                                                               "%1$s% off. %2$s normally, discounted to %3$s",
	"Discount_ARIA_Label_SpecialPrice":                                                  "Special price of %1$s",
	"Generic_More_Info":                                                                 "More Information",
	"Account_Safety_Header":                                                             "Keep Your Account Safe",
	"Account_Safety_Notice":                                                             "NOTE: Valve or Steam representatives will NEVER contact you via chat. Use extreme caution when opening links, especially if they require signing into Steam. If it is suspicious, unexpected, urgent, or generous then it is likely a scam.",
	"Account_Safety_Notice_Report":                                                      "Valve or Steam representatives will NEVER contact you via chat.",
	"SaleSectionCalendar_Upcoming":                                                      "Your Personal Calendar",
	"SaleSectionCalendar_Upcoming_Sub":                                                  "Here's what's coming for you: Recommendations, items from your Wishlist, and More",
	"SaleSectionCalendar_Recent":                                                        "Recently Released",
	"SaleSectionCalendar_Recent_Sub":                                                    "Recommended and Wishlisted games that have released in the last %1$s days",
	"SaleSectionCalendar_Today":                                                         "Today",
	"SaleSectionCalendar_Tomorrow":                                                      "Tomorrow",
	"SaleSectionCalendar_SeeFull":                                                       "See Full Calendar",
	"SaleSectionCalendar_ShowMore":                                                      "Show Four Weeks",
	"SaleSectionNextFestHeader_ExplorationMode_Title":                                   "EXPLORATION MODE",
	"SaleSectionNextFestHeader_ExplorationMode_SubTitle":                                "How would you like to browse Next Fest?",
	"SaleSectionNextFestHeader_ExplorationMode_Random":                                  "Random",
	"SaleSectionNextFestHeader_ExplorationMode_Personalized":                            "Personalized",
	"SaleSectionNextFestHeader_ExplorationMode_DescriptionNotReady1":                    "Steam is still learning about the games in this event.",
	"SaleSectionNextFestHeader_ExplorationMode_DescriptionNotReady2":                    "Starting %1$s at %2$s, Next Fest will automatically become personalized.",
	"SaleSectionNextFestHeader_ExplorationMode_DescriptionReady1":                       "Personalized: Next Fest will prioritize showing games recommended for you.",
	"SaleSectionNextFestHeader_ExplorationMode_DescriptionReady2":                       "Random: Explore unsorted sections for spontaneous discovery.",
	...
	"GameRecording_PlayerError_Generic":                                                 "An error occurred playing this saved recording",
	"GameRecording_PlayerNoContent":                                                     "No Recording Available",
	"GameRecording_PlayerNoContentDescription":                                          "Video frames may have been unavailable, recording may have been turned off, or content may have been removed from the buffer. Please see the <1>FAQ</1> for more details.",
	"GameRecording_PlayerNoContentJumpPrevious":                                         "Jump Previous",
	"GameRecording_PlayerNoContentJumpPrevious_tooltip":                                 "Jump to previous recorded content",
	"GameRecording_PlayerNoContentJumpNoContent_tooltip":                                "No content to jump to",
	"GameRecording_PlayerNoContentJumpNext":                                             "Jump Next",
	"GameRecording_PlayerNoContentJumpNext_tooltip":                                     "Jump to next recorded content",
	...
	"TimelineDialog_NoRecordings":                                                       "No background recordings found. Go play a game!",
	...
	"ClipExport_PreviewErrorTempClip":                                                   "Unable to create a temporary clip (%1$s)",
	"ClipExport_PreviewError":                                                           "Unable to retrieve clip information (%1$s)",
	"ClipExport_PreviewError_InputNotFound":                                             "Unable to get clip preview information because part of the recording is missing. The recording may have been moved or deleted.",
	"ClipExport_PreviewError_ErrorReadingInput":                                         "Unable to get clip preview information due to an error while reading or decoding the source recording files.",
	"ClipExport_PreviewError_UnsupportedSourceCodec":                                    "Unable to get clip preview information because this recording uses an unsupported video format.",
	"ClipExport_PreviewError_ResolutionTooLarge":                                        "Unable to get clip preview information because the selected resolution is too large for this video format. Try a lower resolution.",
	...
	"ClipExport_NoResolutionOptions":                                                    "Steam does not support scaling to resolutions lower than the original recording size.",
	...
	"ClipExport_ExportFailedHeader":                                                     "Export Recording Failed",
	...
	"ExportClip_Error_InvalidParam":                                                     "Failed to export because of a configuration error. Please try different settings.",
	"ExportClip_Error_InputNotFound":                                                    "Failed to export because part of the recording is missing. The recording may have been moved or deleted.",
	"ExportClip_Error_ErrorReadingInput":                                                "Failed to export due to an error while reading or decoding the source recording files.",
	"ExportClip_Error_ErrorWritingOuput":                                                "Failed to export due to an error while writing or encoding the new recording files.",
	"ExportClip_Error_NoHardwareEncoder_H265":                                           "Failed to export because of an error finding or initializing a hardware H.265 encoder on this device. Try selecting H.264 as the output video codec.",
	"ExportClip_Error_NoHardwareEncoder_General":                                        "Failed to export because of an error finding or initializing a hardware video encoder on this device. Try selecting a different output video codec.",
	"ExportClip_Error_UnsupportedSourceCodec":                                           "Failed to export because this recording uses an unsupported video format.",
	"ExportClip_Error_UnsupportedTargetCodec":                                           "Failed to export. Try selecting a different output video codec.",
	"ExportClip_Error_DiskFull":                                                         "%1$s does not have enough room for this exported clip.",
	"ExportClip_Error_ResolutionTooLarge":                                               "Failed to export because the selected resolution is too large for this video format. Try exporting at a lower resolution.",
	"ExportClip_Error_ConverterBusy":                                                    "Failed to export because another export is already in progress. Wait for it to finish and try again.",
	...
	"CreateLink_FileTooLarge":                                                           "Reduce the length of the clip and try again. The current clip is %1$s MB.",
	"CreateLink_Preparing":                                                              "Exporting MP4",
	"CreateLink_ShowQRCode":                                                             "Show QR Code",
	"CreateLink_QRCodePrompt":                                                           "With a QR code you can use your phone's camera to open the link directly in your phone's web browser.",
	"CreateLink_QRCodeDescription":                                                      "Use your phone's camera to scan this QR code to open the clip in your phone's web browser.",
	"SendToChat_ClipTooLong":                                                            "Some options are not available for clips over %2$s seconds. This clip is %1$s long.",
	...
	"SendClip_Description2":                                                             "The next time you sign in to Steam on that device (within the next week), your clip will automatically download there.",
	"SendClip_Description3":                                                             "Send a clip to another PC where you use the Steam Client. Sign in to Steam on that PC within 2 days and the clip will automatically download to your Steam Recordings & Screenshots.",
	"SendClip_Online":                                                                   "Online now",
	"SendClip_NoClients":                                                                "Sign in to Steam from another computer or Steam Deck and use this option to send clips to that computer.",
	"SendClip_NoClients2":                                                               "It looks like you haven't signed into Steam on another PC or Steam Deck recently.",
	"SendClip_FileTooLarge":                                                             "Reduce the length of the clip and try again. The current clip is %1$s MB, and the maximum clip size to send is %2$s MB.",
	...
	"SendToPhone_Description":                                                           "You'll get a notification from the Steam Mobile App when your item is ready to download to your phone.",
	"SendToPhone_DescriptionMobile":                                                     "Don't have the <1>Steam Mobile App</1>?",
	"SendToPhone_DescriptionMobileQR":                                                   "You can <1>scan a QR code</1> with your phone's camera instead.",
	"SendToPhone_CantRequestDevice":                                                     "We could not query your mobile device. Please try again later.",
	"SendToPhone_LoadingPhone":                                                          "",
	"SendToPhone_NoPhone":                                                               "You don't have the Steam Mobile App installed on a device that supports push notifications.",
	"SendToPhone_Update":                                                                "Please update the Steam Mobile App on your mobile device to at least %1$s. This feature is not supported in older versions of the app.",
	"DeleteClip":                                                                        "Delete Clip",
	"DeleteClip_Title":                                                                  "Delete Clip?",
	"DeleteClip_Description":                                                            "Delete %1$s from your computer? This cannot be undone.",
	"DeleteRecording":                                                                   "Delete Recording",
	"DeleteRecording_Title":                                                             "Delete Background Recording?",
	"DeleteRecording_Description":                                                       "Delete this background recording from your computer? This cannot be undone.",
	"Clip_Show_ShareSheet_Tooltip":                                                      "Share this clip",
	"Clip_Delete_Tooltip":                                                               "Delete this clip",
	"Clip_ReplaceWarning_Title":                                                         "Save clip?",
	"Clip_ReplaceWarning_Description":                                                   "Are you sure you want to save over the original clip?",
	"TurnOnGPUAccel_Title":                                                              "Enable GPU Hardware Acceleration",
	"TurnOnGPUAccel_Description":                                                        "<1>To be able to play HEVC (H.265) encoded content, the Steam Client requires that you enable the 'GPU Hardware Acceleration' and 'Hardware Video Decoding' settings.</1><2>Would you like to enable these settings?</2>",
	...
	"Playback_UserSelectionControls_AddUserMarker":                                      "Add Marker at Current Playback",
	"Playback_UserSelectionControls_AddUserMarkerLiveEdge":                              "Add Marker at Current Playtime",
	"Playback_UserSelectionControls_TakeScreenshot":                                     "Take Screenshot at Current Playback",
	"Playback_UserSelectionControls_SetClipStart":                                       "Start Clip at Current Playback",
	...
	"SaleTech_Screenshot_Viewer":                                                        "Screenshot Viewer",
	"Settings_Page_GameRecording":                                                       "Game Recording",
	"Settings_GameRecording_Intro":                                                      "Learn more about the <1>different ways to use Game Recording</1>. Got feedback? <2>We'd like to hear it</2>.",
	...
	"Settings_GameRecording_ModeDescription_Never":                                      "Steam will not record your gameplay.",
	"Settings_GameRecording_ModeDescription_Always":                                     "<1>Steam will automatically record your gameplay when you start playing, so you don't miss those unexpected moments.</1><2>The last <4>%1$s</4> minutes of video will be kept in a temporary format for you to replay or save as permanent clips.</2>",
	"Settings_GameRecording_ModeDescription_Manual":                                     "Steam will record video only after you press %1$s.",
	"Settings_GameRecording_ModeDescription_Manual_Fallback":                            "the bound key below",
	"Settings_GameRecording_BackgroundInstructions":                                     "Allocate space for temporary background recordings. Once full, the oldest gameplay will be overwritten as new gameplay is recorded.",
	"Settings_GameRecording_Path":                                                       "Recordings folder",
	"Settings_GameRecording_Description":                                                "* Raw recordings need to be made clips via the timeline in order to be saved as video files.",
	...
	"Settings_GameRecording_InstantClip":                                                "Save the last <1></1> seconds of gameplay as a clip",
	"Settings_GameRecording_InstantClip_Label":                                          "Clip duration in seconds",
	"Settings_GameRecording_TimelineMarker":                                             "Timeline Markers",
	"Settings_GameRecording_TimelineMarker_Description":                                 "You can annotate your recordings with Timeline Markers. These can be used to reference moments to revisit and/or automatically save footage within a specified time range.",
	"Settings_GameRecording_BackgroundSettings":                                         "Background recording disk space",
	...
	"Settings_GameRecording_DiskSpaceTooltip":                                           "Steam will match the game's video resolution to choose an appropriate bit rate for each recording. Higher game resolutions require more disk space.",
	"Settings_GameRecording_VideoHardwareEncoding":                                      "Enable GPU hardware encoding",
	"Settings_GameRecording_VideoEnableH265":                                            "Enable HEVC (H.265) video codec",
	"Settings_GameRecording_Shortcut_Title":                                             "Shortcut Keys",
	"Settings_GameRecording_RequiresGPUAcceleration":                                    "Requires Steam Client GPU Acceleration",
	...
	"Settings_GameRecording_Length_Modal_MinutesExplainer":                              "Steam will save the most recent %1$s minutes of video.",
	"Settings_GameRecording_Length_Modal_SetMinutes":                                    "%1$s Minutes",
	"Settings_GameRecording_Length_Modal_Infinite":                                      "Infinite",
	"Settings_GameRecording_Length_Modal_InfiniteExplainer":                             "Steam will record indefinitely as long as space is available.",
	"Settings_GameRecording_Length_Modal_Disabled":                                      "Do Not Record",
	"Settings_GameRecording_Length_Modal_NeverExplainer":                                "Steam will never record this game. Recording hotkeys disabled.",
	...
	"Settings_Hotkey_Modal_NotBound":                                                    "None",
	...
	"Settings_GameRecording_PerGameSettings_AddGame_Title":                              "Add game-specific settings here",
	"Settings_GameRecording_PerGameSettings_AddGame_Button":                             "Add Game",
	"Settings_GameRecording_OptOut_Title":                                               "Do not record list",
	"Settings_GameRecording_OptOut_Description":                                         "Games added here will not automatically record",
	...
	"Settings_GameRecording_AudioRecording_Mic_Description":                             "Enables recording of your system microphone input along with gameplay audio.",
	"Settings_GameRecording_AudioRecording_MicMono":                                     "Force Microphone to Mono",
	"Settings_GameRecording_AudioRecording_MicMono_Description":                         "Select if you hear your microphone only in one channel during playback.",
	"Settings_GameRecording_AudioRecording_AGC":                                         "Automatic Gain Control",
	"Settings_GameRecording_AudioRecording_AGC_Description":                             "Automatically adjusts microphone recording level for consistent volume and clarity.",
	"Settings_GameRecording_SystemAudio":                                                "Record All System Audio",
	"Settings_GameRecording_SystemAudio_Description":                                    "Enables recording sound from all processes running on your computer",
	"Settings_GameRecording_AudioRecording_AdditionalProcesses":                         "Select additional programs to record audio from:",
	...
	"Settings_GameRecording_Cleanup_Confirm":                                            "Are you sure you want to delete all existing recordings?",
	...
	"Settings_GameRecording_AudioSelection_SelectProcesses":                             "Game and Selected Programs",
	"Settings_GameRecording_AudioSelection_Explainer_SystemOnly_Windows":                "Recording of game audio is supported on Windows build 19044 and newer. On older versions of Windows, only system audio recording is supported.",
	"Settings_GameRecording_AudioSelection_Explainer_SystemOnly":                        "Recording of game audio is not supported on this platform. Only system audio recording is supported.",
	"Settings_GameRecording_LowDiskSpace_Header":                                        "Low disk space - Unable to record or create clips",
	"Settings_GameRecording_LowDiskSpace_Description":                                   "To free space on your hard drive you can delete files, modify your background recording settings, or change the location of your recording folder to another drive.",
	"Settings_GameRecording_NotEnoughDiskSpace":                                         "Not enough hard drive space for your selection (%1$s available)",
	"Settings_VideoRecording_DriverCheck_Header":                                        "Update your graphics driver",
	"Settings_VideoRecording_NvidiaDriverUpdate":                                        "Your NVIDIA driver is out of date. To use your graphics card to speed up video encoding, update to the latest driver version (%1$s or newer) from the NVIDIA website, then restart Steam.",
	"Settings_GameRecording_BitRate_Ultra":                                              "<1>Ultra</1> - Least compression, most disk space",
	"Settings_GameRecording_BitRate_High":                                               "<1>High (Default)</1> - Best for most games",
	"Settings_GameRecording_BitRate_Medium":                                             "<1>Medium</1> - Balanced, some quality loss",
	"Settings_GameRecording_BitRate_Low":                                                "<1>Low</1> - Most compression, least disk space",
	...
	"Settings_GameRecording_BitRate_Modal_Auto_Explainer":                               "Steam uses the game's video resolution to choose an appropriate bit rate for each recording. Selecting a higher quality level will result in a better looking recording but consume more disk space.",
	...
	"Settings_GameRecording_VideoMaxHeight_Description":                                 "Width will be automatically set to preserve the game's aspect ratio",
	...
	"ClipManager_Explainer_Header":                                                      "Here's where you'll find the screenshots, clips, and game recordings you've taken in game.",
	"ClipManager_Explainer_ScreenshotTip":                                               "Take a screenshot by pressing %1$s while in game.",
	"ClipManager_Explainer_RecordingHeader":                                             "<1>NEW!</1> Game Recordings",
	"ClipManager_Explainer_Recording":                                                   "An easy way to record, rewind, review, clip, save & share your gameplay.",
	"ClipManager_Explainer_RecordingGetStarted":                                         "Get started...",
	"ClipManager_Explainer_AllContentFilteredOut":                                       "No media matches the current filters. Please change the filter options above to see results",
	...
	"RecordingState_ManualRecAnotherRecordingGoing":                                     "Currently Recording Another Game",
	"RecordingState_ManualRec_LowDiskSpace":                                             "Not Enough Space to Start Recording",
	"RecordingState_ActiveBroadcast":                                                    "Disable Broadcast to Record Game",
	"RecordingState_ActiveBroadcastTooltip":                                             "Recording Disabled While Broadcast Active",
	"RecordingState_ActiveRemotePlay":                                                   "Disable Remote Play to Record Game",
	"RecordingState_ActiveRemotePlayTooltip":                                            "Recording Disabled While Streaming for Remote Play",
	"RecordingState_Clip_LowDiskSpace":                                                  "Not enough space to prepare or save clips. View Settings for more.",
	"RecordingState_LowDiskSpace_CTA":                                                   "Open Settings",
	"RecordingState_BackgroundRec_LowDiskSpace":                                         "Disk space too low to record",
	"RecordingState_BackgroundRec_AnotherRecordingGoing":                                "%1$s Recording other game",
	"RecordingState_BackgroundRec_OpenRecording":                                        "%1$s Open recording",
	"RecordingState_BackgroundRec_SwitchRecordedGame":                                   "Switch to recording this game",
	...
	"MediaManager_DeleteDialog_Explainer":                                               "Are you sure you want to delete this item?",
	"MediaManager_DeleteDialog_Explainer_Plural":                                        "Are you sure you want to delete these %1$s items?",
	"MediaManager_DeleteDialog_RecordingInProgress":                                     "Error: a background recording cannot be deleted while recording is in progress.",
	"MediaManager_DeleteDialog_RecordingInProgress_Subtext":                             "You can stop recording or change your <1>Recording Settings here</1>.",
	"MediaManager_DeleteDialog_RecordingRecreation":                                     "A game's background recording file will be recreated the next time you play unless you <1>change your Recording Settings</1>.",
	"MediaManager_DeleteDialog_SizeInfo":                                                "%1$s of cloud storage will be regained",
	...
	"UserPolls_status_N_Votes":                                                          "%1$s VOTE",
	"UserPolls_status_N_Votes_Plural":                                                   "%1$s VOTES",
	"UserPolls_status_N_TimeRemaining":                                                  "%1$s REMAINING",
	"UserPolls_JustSeeResults":                                                          "Just see the responses",
	...
	"Settings_GameRecording_Gamepad_ToggleRecordingHotkey":                              "Controller Shortcut to start/stop recording:",
	"Settings_GameRecording_Gamepad_MarkHotkey":                                         "Controller Shortcut to add a timeline marker:",
	"Settings_GameRecording_Gamepad_Clip":                                               "Controller Shortcut to create a clip:",
	...
	"GamepadOverlay_GameRecording_GoToSettings_GameRecording":                           "Recording Settings",
	"GamepadOverlay_GameRecording_GoToSettings_RemotePlay":                              "Remote Play Settings",
	"GamepadOverlay_GameRecording_GoToSettings_Broadcast":                               "Broadcast Settings",
	"GamepadOverlay_GameRecording_GoToRecording":                                        "View  Background Recording",
	"GamepadOverlay_GameRecording_ToggleRecordingExplainer":                             "Shortcut chord to start/stop recording while in game:",
	"GamepadOverlay_GameRecording_ClipExplainer":                                        "Shortcut chord to make a clip while in game:",
	"GamepadOverlay_GameRecording_AddMarkerExplainer":                                   "Shortcut chord to drop a timeline marker %1$s:",
	"GamepadOverlay_GameRecording_RecordingStateExplainer":                              "Currently recording all gameplay footage",
	"GamepadOverlay_GameRecording_RecordingDisabledRemotePlayExplainer":                 "Game Recording disabled while Streaming for Remote Play",
	"GamepadOverlay_GameRecording_RecordingDisabledBroadcastExplainer":                  "Game Recording disabled while Broadcasting",
	"GamepadOverlay_GameRecording_NotRecordingExplainer":                                "Game recording is currently disabled",
	...
	"QuickAccess_Tab_GameRecording_ManualRecordingToggle_Explainer":                     "(Record this game session)",
	"QuickAccess_Tab_GameRecording":                                                     "Game Recording",
	"GameRecording_Dummy_DO_NOT_USE":                                                    "",
	"AccessibilityFeatures":                                                             "Accessibility Features",
	"AccessibilityFeaturesWithCount":                                                    "Accessibility Features (%1$s)",
	"Accessibility_Feature_AdjustableDifficulty":                                        "Adjustable Difficulty",
	"Accessibility_Feature_SaveAnytime":                                                 "Save Anytime",
	"Accessibility_Feature_NarratedMenus":                                               "Narrated Game Menus",
	"Accessibility_Feature_CustomVolumeControls":                                        "Custom Volume Controls",
	"Accessibility_Feature_StereoSound":                                                 "Stereo Sound",
	"Accessibility_Feature_SurroundSound":                                               "Surround Sound",
	"Accessibility_Feature_AdjustableTextSize":                                          "Adjustable Text Size",
	"Accessibility_Feature_SubtitleOptions":                                             "Subtitle Options",
	"Accessibility_Feature_ColorAlternatives":                                           "Color Alternatives",
	"Accessibility_Feature_CameraComfort":                                               "Camera Comfort",
	"Accessibility_Feature_ContrastControls":                                            "Contrast Controls",
	"Accessibility_Feature_PlayableWithoutVision":                                       "Playable without Vision",
	"Accessibility_Feature_KeyboardOnlyOption":                                          "Keyboard Only Option",
	"Accessibility_Feature_MouseOnlyOption":                                             "Mouse Only Option",
	"Accessibility_Feature_TouchOnlyOption":                                             "Touch Only Option",
	"Accessibility_Feature_WithoutQuickTimeEvents":                                      "Playable without Quick Time Events",
	"Accessibility_Feature_PlayableAtYourOwnPace":                                       "Playable at Your Own Pace",
	"Accessibility_Feature_TextToSpeech":                                                "Chat Text-to-speech",
	"Accessibility_Feature_SpeechToText":                                                "Chat Speech-to-text",
	"Accessibility_Group_Gameplay":                                                      "Gameplay",
	"Accessibility_Group_Visual":                                                        "Visual",
	"Accessibility_Group_Audio":                                                         "Audio",
	"Accessibility_Group_Input":                                                         "Input",
	"SteamNotifications_TradeReversal_Title":                                            "Trade Protection",
	"SteamNotifications_TradeReversal_Body":                                             "A trade was reversed",
	"SteamNotifications_TradeReversal_Body_Short":                                       "A trade was reversed",
	"SteamNotifications_TradeReversal_Description":                                      "One of your recent trades was reversed by your trade partner.",
	"GameFrameRateReporting_Title":                                                      "Anonymous framerate data:",
	"GameFrameRateReporting_Prompt":                                                     "Can we collect anonymized framerate data while you are playing games and logged in with your Steam account? This data helps us learn about game compatibility and improve Steam.",
	"GameFrameRateReporting_Details_Title":                                              "Anonymous framerate data",
	"GameFrameRateReporting_Details_Desc":                                               "If you opt in to this, gameplay framerate data will be stored without a connection to your Steam account, but identified with the kind of hardware you are playing on.  This data helps us learn about game compatibility and improve the experience on devices running Steam.",
	"GameFrameRateReporting_Details_HowToChange":                                        "If you'd like to change the setting later, you can find it in Steam Account Settings",
	"GameFrameRateReporting_LearnMore":                                                  "Learn More",
	"GamePerformanceStats_Header":                                                       "Steam Deck Compatibility",
	"GamePerformanceStats_CustomerFeedback":                                             "Steam Deck Verified - Customer Feedback",
	"GamePerformanceStats_NoData":                                                       "No data available",
	"GamePerformanceStats_Feedback_Agree":                                               "%1$s of respondents agree with this game's %2$s rating. For context, the average agreement rating across all Deck Verified games is 95%.",
	"GamePerformanceStats_Feedback_AgreePercentage":                                     "%1$s%",
	"GamePerformanceStats_Feedback_PercentageTooltip":                                   "We're providing this data because while customers overwhelmingly agree with the Verified rating for titles (>95%), it can be valuable to better understand the experiences of customers who disagree, especially in the context of a specific title or update.",
	"GamePerformanceStats_Performance":                                                  "Performance",
	"GamePerformanceStats_Legibility":                                                   "Legibility",
	"GamePerformanceStats_Stability":                                                    "Stability",
	"GamePerformanceStats_Input":                                                        "Input",
	"GamePerformanceStats_Other":                                                        "Other",
	"GamePerformanceStats_NumberOfReports":                                              "This data is based on %1$s reports over the past %2$s days from customers who opted-in to providing feedback on Steam Deck.",
	"GamePerformanceStats_WhyDisagree":                                                  "Customers who %1$s with the game's %2$s status offered the following reasons as to why they did not agree.",
	"GamePerformanceStats_DidNotAgree":                                                  "did not agree",
	"GamePerformanceStats_AverageFrameRate_Title":                                       "Average Steam Deck Framerate",
	"GamePerformanceStats_AverageFrameRate":                                             "The average reported framerate for %1$s on Steam Deck is %2$s",
	"GamePerformanceStats_AverageFrameRate_ThisGame":                                    "The average reported framerate for this game on Steam Deck is %1$s",
	"GamePerformanceStats_FPS":                                                          "%1$s FPS",
	"GamePerformanceStats_FrameRateDataBasedOn":                                         "This data is based on framerate reports over the past %1$s days from customers who opted-in to providing framerate data.",
	"GamePerformanceStats_FrameRateMoreInfo":                                            "Note: Variance is not currently provided but is planned during the Beta.  With variance data you will be able to see if framerate is steady or fluctuates a great deal.",
	"GamePerformance_Reason":                                                            "Reason",
	"GamePerformance_NumResponses":                                                      "# Responses",
...
func SteamDecodeLocToken(token string) string {
	return steamLocTokenStrings[strings.TrimPrefix(token, "#")]
}
